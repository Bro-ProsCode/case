...
export const pagesConfig = {
  ...
  home: {
    title: 'Home',
    description: 'Computer and Data Science major learning the secrets of the universe.',
  },
  ...
  projects: {
    ...
    description: 'Detailed case studies showcasing my problem-solving approach, technical decisions, and measurable impact across computer and data science projects.',
    heading: 'Projects',
